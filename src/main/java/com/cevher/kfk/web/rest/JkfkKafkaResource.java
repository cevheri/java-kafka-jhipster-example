...
@RestController
@RequestMapping("/api/jkfk-kafka")
public class JkfkKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JkfkKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JkfkKafkaResource(KafkaProperties kafkaProperties) {
